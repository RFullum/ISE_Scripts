 ...
 */
public class ColorChangerLowMids : MonoBehaviour
{
    ...
    void Update()
    {
         ...
         */
        float scaleRedVal = mapValues.remapValues(meterVal, -80.0f, 10.0f, 1.0f, 0.0f);
        float scaleGreenVal = mapValues.remapValues(meterVal, -80.0f, 10.0f, 1.0f, 0.933333f);
        float scaleBlueVal = mapValues.remapValues(meterVal, -80.0f, 10.0f, 1.0f, 1.0f);
        var colorRender = gameObject.GetComponent<Renderer>();
