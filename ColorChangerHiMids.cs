 ...
 */
public class ColorChangerHiMids : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float meterVal = HiMidsMeterRTPC.meterValue;
         ...
         */
        float scaleRedVal = mapValues.remapValues(meterVal, -80.0f, 10.0f, 1.0f, 0.984314f);
